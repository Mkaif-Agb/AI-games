...
class Environment():
    ...
    def __init__(self):
        ...
        #Required Sprites
        self.loadSprite('AI_for_Games/Q-Learning/Player.png')
        self.loadSprite('AI_for_Games/Q-Learning/Wall.png')
        self.loadSprite('AI_for_Games/Q-Learning/Finish.png')
        
        #Additional Sprites
        self.loadSprite('AI_for_Games/Q-Learning/Fire.png')
        self.loadSprite('AI_for_Games/Q-Learning/Water.png')
